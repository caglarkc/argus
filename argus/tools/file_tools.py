...
from argus.cli.highlighted_content import HighlightedContentDisplay
...
"""
@register_tool(name="write_file", providers=["claude", "argus"])
    ...
    async def _generate_confirmation_panel(self, **kwargs):
        ...
        if file_exists:
            try:
                ...
                panel = HighlightedContentDisplay.create_side_by_side_comparison(old_content, content, path,)
            ...
            panel = HighlightedContentDisplay.create_write_file_result_display(content, path, is_new_file=True,)
...
@register_tool(name="read_file", providers=["claude", "argus"])
