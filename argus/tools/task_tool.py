...
from argus.llm.llm_basics import ToolCallResult, LLMMessage
from argus.tools.base_tool import BaseTool
...
class TaskTool(BaseTool):
    ...
    async def execute(self, **kwargs) -> ToolCallResult:
        ...
        try:
            ...
            return ToolCallResult(call_id="task_tool",
    ...
    def _get_task_system_prompt(self, description: str, task_id: str) -> str:
        ...
        return SYSTEM_PROMPT_TEMPLATE.format(description=description,
            task_id=task_id)
