...
from argus.llm.llm_basics import ToolCallResult, ToolCall
...
class TrajectoryRecorder:
    ...
    def __init__(self, trajectory_path: Optional[Path] = None):
        ...
        self.trajectory_data: Dict[str, Any] = {
            ...
            "final_result": None,
            "execution_time": 0.0,
            "total_tokens": 0,  # messagetokenmessage
    ...
    def start_recording(self, task: str, provider: str, model: str, max_steps: int):
        ...
        # message,messageinteractionsmessagesteps
    ...
    def record_llm_interaction(self,
        ...
        # messagesession stats
        session_stats.record_llm_interaction(provider=provider,
            model=model,
