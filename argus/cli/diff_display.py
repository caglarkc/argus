...
class DiffDisplay:
    ...
    @staticmethod
    def create_side_by_side_diff(old_content: str, 
        new_content: str, 
        old_label: str = "Before", 
        new_label: str = "After",
        context_lines: int = 3) -> Panel:
    ...
    @staticmethod
    def create_unified_diff(old_content: str, 
        new_content: str, 
        file_path: str = "file",
        context_lines: int = 3) -> Panel:
        ...
        if not diff_lines:
            return Panel(Text("No changes detected", style="dim"),
                title="📝 Diff",
                border_style="blue")
    ...
    @staticmethod
    def create_edit_preview(original_content: str,
        old_text: str,
        new_text: str,
        file_path: str,
        context_lines: int = 3) -> Panel:
    ...
    @staticmethod
    def create_write_file_preview(content: str,
        file_path: str,
        is_new_file: bool = True,
        old_content: str = "",
        max_lines: int = 20) -> Panel:
...
def show_diff_confirmation(operation: str,
    file_path: str,
    old_content: str = "",
    new_content: str = "",
    old_text: str = "",
