...
class HelpCommand(BaseCommand):
    ...
    async def execute(self, context, args: str) -> dict:
        ...
        panel = Panel(help_content,
            title="Argus CLI Help",
            border_style="blue",
            padding=(1, 2))
