...
def run_tool_with_hooks(*,
    ...
    tool_callable: Callable[[Dict[str, Any]], Dict[str, Any]],) -> Tuple[bool, Optional[str], Optional[Dict[str, Any]]]:
    """
    message:
    - message PreToolUse
    - message -> message
    - message PostToolUse
    message: (success, user_msg, tool_response_or_none)
    """
    # PreToolUse
    cont, msg, _ = hook_manager.emit(event=HookEvent.PreToolUse,
    ...
    # PostToolUse
    cont2, msg2, extra2 = hook_manager.emit(event=HookEvent.PostToolUse,
        base_payload=session_ctx,
        tool_name=tool_name,
        tool_input=tool_input,
